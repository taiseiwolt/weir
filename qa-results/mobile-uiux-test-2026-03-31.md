...
| 3 | メニュー・カート | iPhone_SE | UX-09: 画面読み込み正常 | title="焼肉 炭火亭 渋谷店 | AIden モバイルオーダー", content=false | aiden-order-store_iPhone_SE.png |
...
| 12 | メニュー・カート | iPhone_14_Pro | UX-09: 画面読み込み正常 | title="焼肉 炭火亭 渋谷店 | AIden モバイルオーダー", content=false | aiden-order-store_iPhone_14_Pro.png |
...
| 20 | メニュー・カート | Galaxy_S21 | UX-09: 画面読み込み正常 | title="焼肉 炭火亭 渋谷店 | AIden モバイルオーダー", content=false | aiden-order-store_Galaxy_S21.png |
...
| UX-07 | カテゴリタブ横スクロール | PASS | タブなし |
| UX-08 | 価格全桁表示 | PASS | OK |
| UX-09 | 画面読み込み正常 | **FAIL** | title="焼肉 炭火亭 渋谷店 | AIden モバイルオーダー", content=false |
...
| UX-07 | カテゴリタブ横スクロール | PASS | タブなし |
| UX-08 | 価格全桁表示 | PASS | OK |
| UX-09 | 画面読み込み正常 | PASS | title="注文の最終確認 - 焼肉 炭火亭 渋谷店 | AIden", content=true |
| UX-10 | カート±ボタンサイズ | PASS | 対象外ページ |
...
| UX-07 | カテゴリタブ横スクロール | PASS | タブなし |
| UX-08 | 価格全桁表示 | PASS | OK |
| UX-09 | 画面読み込み正常 | PASS | title="注文状況 - 焼肉 炭火亭 渋谷店 | AIden", content=true |
| UX-10 | カート±ボタンサイズ | PASS | 対象外ページ |
| UX-11 | input type適切 | PASS | email=0, tel=0, number=0 |
| UX-12 | Stripe決済フォーム | PASS | 対象外ページ |
| UX-13 | 予約モーダル | PASS | 対象外ページ |
