...
**Goal:** `weir-admin.html` のメニュー管理セクションを、display_id検索起点の3ペインUIに全面刷新する。
...
**Files:**
- Modify: `weir-admin.html` (lines 715-1222 周辺)
...
**Files:**
- Modify: `weir-admin.html:715`

- [ ] **Step 1: 既存の menusState 宣言を読む**

Run: `sed -n '715,716p' weir-admin.html`
...
**Files:**
- Modify: `weir-admin.html:718-725`

- [ ] **Step 1: 既存のrenderMenusPageを読む**

Run: `sed -n '718,725p' weir-admin.html`
...
**Files:**
- Modify: `weir-admin.html:727-731`

- [ ] **Step 1: 既存initMenusPageを読む**

Run: `sed -n '727,731p' weir-admin.html`
...
**Files:**
- Modify: `weir-admin.html:732` 付近（initMenusPage の直後に挿入）
...
**Files:**
- Modify: `weir-admin.html:733-774`

- [ ] **Step 1: 対象範囲を確認**

Run: `sed -n '733,774p' weir-admin.html`
...
**Files:**
- Modify: `weir-admin.html` — Task 5 の削除後の位置に挿入
...
**Files:**
- Modify: `weir-admin.html` — Task 6 の直後に挿入
...
**Files:**
- Modify: `weir-admin.html` — Task 7 の直後に挿入
...
**Files:**
- Modify: `weir-admin.html:776-796`

- [ ] **Step 1: 既存の menusRenderPatternList を読む**

Run: `sed -n '776,796p' weir-admin.html`
...
**Files:**
- Modify: `weir-admin.html` 全体（`selectedBrandUuid` / `selectedBrandDisplayId` の参照全て）

- [ ] **Step 1: 対象を洗い出す**

Run: `grep -n "selectedBrandUuid\|selectedBrandDisplayId" weir-admin.html`
Expected: 約12〜15箇所
...
**Files:**
- Modify: `weir-admin.html:798-828` (menusSelectPattern)
...
Run: `sed -n '830,876p' weir-admin.html`
...
```
# ブラウザで http://localhost:PORT/weir-admin.html を開く
# サイドバーから「メニュー管理」クリック
```
...
Run: `git status && git diff weir-admin.html | head -100`

- [ ] **Step 4: git add → commit**

```bash
git add weir-admin.html docs/superpowers/plans/2026-04-11-menu-management-search-ui.md
