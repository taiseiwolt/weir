...
- `aiden-brand-news.html` — update internal links
- `aiden-brand-stores.html` — update internal links
- `aiden-brand-menu.html` — update internal links
- `aiden-privacy.html` — update internal links
- `aiden-sitemap.html` — update internal links + add news detail entry
- `aiden-terms-v1.3.html` — update internal links
- `aiden-order.html` — update internal links
- `aiden-order-v21.html` — update internal links
- `aiden-membership.html` — update internal links
- `aiden-customer-admin.html` — update internal links + add admin sections
- `index.html` — update demo link
- `aiden-order-store.html` — add `type` URL parameter support
- `aiden-admin.html` — add carousel/campaign/news/custom_domain management sections
...
- Line 108: Link propagation in DOMContentLoaded — change `./aiden-brand-` prefix check to `./brand` and `./aiden-brand-` (both patterns since subpages still use `aiden-brand-` prefix)

- [ ] **Step 3: Update internal links in all other HTML files**

Replace `./aiden-brand-sushiro.html` with `./brand.html` in these files:

| File | Lines |
|------|-------|
| `aiden-brand-news.html` | 80, 111 |
| `aiden-brand-stores.html` | 183, 208 |
| `aiden-brand-menu.html` | 174, 203 |
| `aiden-privacy.html` | 60, 187 |
| `aiden-sitemap.html` | 60, 74, 76, 77, 78, 180 |
| `aiden-terms-v1.3.html` | 45, 148 |
| `aiden-order.html` | 619 |
| `aiden-order-v21.html` | 619 |
| `aiden-membership.html` | 133 |
| `aiden-customer-admin.html` | 2646 |
| `index.html` | 90 (change `/aiden-brand-sushiro.html` to `/brand.html`) |
...
```json
{ "source": "/", "destination": "/aiden-brand-sushiro.html" }
```
to:
```json
...
```json
{ "source": "/aiden-brand-sushiro.html", "destination": "/brand.html" }
```
...
document.addEventListener('DOMContentLoaded', async function() {
  if (_brandParam) {
    document.querySelectorAll('a[href]').forEach(function(a) {
      ...
      if (h && (h.startsWith('./aiden-brand-') || h === './brand.html') && !h.includes('brand=')) {
...
Change:
```html
<a href="./aiden-membership.html" class="header-nav-link" data-i18n="nav_membership">会員プログラム</a>
```
To:
```html
<a href="./aiden-membership.html" class="header-nav-link" data-i18n="nav_membership">会員特典</a>
```

Also update in mobile nav (line 326):
```html
<a href="./aiden-membership.html" data-i18n="nav_membership">🏆 会員特典</a>
```
...
- Modify: `aiden-order-store.html` (type param support)

- [ ] **Step 1: Update CTA buttons in brand.html**

The MENU CTA section (lines 362-378) already has separate takeout/delivery buttons linking to `./aiden-order.html?mode=takeout` and `./aiden-order.html?mode=delivery`. The spec asks for direct links to `aiden-order-store.html?store_id=xxx&type=takeout`.
...
<div class="mobile-nav-cta">
  ...
  <a href="./aiden-order.html?mode=takeout" data-i18n="nav_order_short">🥡 お持ち帰り</a>
  <a href="./aiden-order.html?mode=delivery">🛵 デリバリー</a>
</div>
```

- [ ] **Step 2: Add type param support in aiden-order-store.html**

In `aiden-order-store.html`, add URL parameter reading after the `orderMode` declaration (around line 1062):
...
```bash
git add brand.html aiden-order-store.html
...
- Modify: `aiden-brand-news.html` (news item links)
...
The file should follow the same patterns as other brand sub-pages (aiden-brand-news.html etc.):
...
<article class="news-detail">
  <div class="news-detail-inner">
    <nav class="breadcrumb">
      ...
      <a href="./aiden-brand-news.html">ニュース</a> &gt;
    ...
    <div class="news-detail-back">
      <a href="./aiden-brand-news.html">← ニュース一覧に戻る</a>
    </div>
  </div>
</article>
```
...
Full file content is ~300 lines, following the pattern of `aiden-brand-news.html` for header/footer structure.
...
In `aiden-brand-news.html`, update the news item rendering to link to `brand-news-detail.html?news_id=xxx` instead of `#` or external URLs.

- [ ] **Step 4: Commit**

```bash
git add brand-news-detail.html brand.html aiden-brand-news.html
...
<footer>
  <div class="footer-main">
    ...
    <!-- メニュー -->
    <div><div class="footer-nav-title" data-i18n="footer_menu">メニュー</div><div class="footer-nav-list"><a href="./aiden-brand-menu.html" data-i18n="f_grand_menu">グランドメニュー</a><a href="./aiden-brand-menu.html" data-i18n="f_yakiniku">焼肉・特選肉</a><a href="./aiden-brand-menu.html" data-i18n="f_rice">ご飯・麺</a><a href="./aiden-brand-menu.html" data-i18n="f_drink">ドリンク</a><a href="./aiden-brand-menu.html" data-i18n="f_course">コース・プラン</a></div></div>
    <!-- サービス -->
    <div><div class="footer-nav-title" data-i18n="footer_service">サービス</div><div class="footer-nav-list"><a href="javascript:void(0)" data-i18n="cta_reserve" onclick="openResModal()">来店予約</a><a href="./aiden-order.html?mode=takeout" data-i18n="cta_takeout">お持ち帰り</a><a href="./aiden-order.html?mode=delivery" data-i18n="cta_delivery">デリバリー</a><a href="./aiden-membership.html" data-i18n="nav_membership">会員特典</a></div></div>
    <!-- 会社情報 -->
    <div>
    ...
    <div>
      ...
      <div class="footer-nav-list"><a href="./aiden-brand-news.html" data-i18n="news_more_link">ニュース一覧</a></div>
    </div>
  </div>
...
In `aiden-admin.html`, find the `brand-hp` tab content (around line 1101) and add after the publication status:
...
Open `aiden-admin.html`, navigate to brand management, and verify:
